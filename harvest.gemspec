# -*- encoding: utf-8 -*-
 ...
 Gem::Specification.new do |s|
  ...
  s.files       = ["HISTORY", "LICENSE", "Rakefile", "README.rdoc", "lib/harvest/plugins/active_resource_inheritable_headers.rb", "lib/harvest/plugins/toggleable.rb", "lib/harvest/resources/client.rb", "lib/harvest/resources/contact.rb", "lib/harvest/resources/entry.rb", "lib/harvest/resources/expense.rb", "lib/harvest/resources/expense_category.rb", "lib/harvest/resources/invoice.rb", "lib/harvest/resources/invoice_payment.rb", "lib/harvest/resources/invoice_message.rb", "lib/harvest/resources/person.rb", "lib/harvest/resources/project.rb", "lib/harvest/resources/task.rb", "lib/harvest/resources/task_assignment.rb", "lib/harvest/resources/user_assignment.rb", "lib/harvest/base.rb", "lib/harvest/harvest_resource.rb", "lib/harvest.rb"]
  s.require_paths = ["lib"]
